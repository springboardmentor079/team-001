...
import { HardHat, LogOut, ShieldCheck, Bell } from 'lucide-react';

export const Navbar = ({ currentUser, onLogout }) => {
  return (
    <header className="h-16 border-b border-slate-800 bg-slate-900/90 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-40 backdrop-blur">
